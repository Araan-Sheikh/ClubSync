      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-2xl">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              type="submit"
              disabled={loading}
              className="w-full bg-navy hover:bg-navy-light text-white font-inter font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 flex items-center justify-center"
          ...
          <p className="text-center mt-6 font-inter text-sm text-navy/70">
            ...
            <button onClick={() => navigate('/signup')} className="text-violet-soft hover:text-violet-light font-semibold transition-colors duration-300">
              Sign Up
            </button>
          </p>
        </motion.div>
        ...
        >
          ...
          <div 
            ...
            style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?q=80&w=2049)', backgroundSize: 'cover', backgroundPosition: 'center' }}
          ></div>
